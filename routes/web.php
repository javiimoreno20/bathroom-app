...
Route::middleware('teacher.auth')->group(function () {
    ...
    /*
    |--------------------------------------------------------------------------
    | CAMBIO DE CONTRASEÑA (SOLO LOGUEADOS)
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    Route::get('/dashboard', [BathroomPermissionController::class, 'index'])
        ->name('dashboard');

    Route::post('/give-permission', [BathroomPermissionController::class, 'givePermission'])
        ->name('give.permission');

    Route::post('/mark-returned/{id}', [BathroomPermissionController::class, 'markReturned'])
        ->name('mark.returned');

    Route::get('/permissions/history', [BathroomPermissionController::class, 'history'])
        ->name('permissions.history');

    Route::post('/export-permissions', [BathroomPermissionController::class, 'exportPermissions'])
